...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function hc(){return new $t({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:lo(),fragmentShader:`
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function uc(){return new $t({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:lo(),fragmentShader:`
	...
	`}function Jp(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const c=o.mapping,l=c===jr||c===$r,h=c===Ri||c===Ci;if(l||h){let u=e.get(o);const d=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return t===null&&(t=new cc(i)),u=l?t.fromEquirectangular(o,u):t.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),u.texture;if(u!==void 0)return u.texture;{const p=o.image;return l&&p&&p.height>0||h&&p&&s(p)?(t===null&&(t=new cc(i)),u=l?t.fromEquirectangular(o):t.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),o.addEventListener("dispose",r),u.texture):null}}}return o}function s(o){let c=0;const l=6;for(let h=0;h<l;h++)o[h]!==void 0&&c++;return c===l}function r(o){const c=o.target;c.removeEventListener("dispose",r);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function jp(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&Hi("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function $p(i,e,t,n){const s={},r=new WeakMap;function a(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const S=d.morphAttributes[g];for(let m=0,f=S.length;m<f;m++)e.remove(S[m])}d.removeEventListener("dispose",a),delete s[d.id];const p=r.get(d);p&&(e.remove(p),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(u,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,t.memory.geometries++),d}function c(u){const d=u.attributes;for(const g in d)e.update(d[g],i.ARRAY_BUFFER);const p=u.morphAttributes;for(const g in p){const S=p[g];for(let m=0,f=S.length;m<f;m++)e.update(S[m],i.ARRAY_BUFFER)}}function l(u){const d=[],p=u.index,g=u.attributes.position;let S=0;if(p!==null){const b=p.array;S=p.version;for(let M=0,_=b.length;M<_;M+=3){const U=b[M+0],A=b[M+1],R=b[M+2];d.push(U,A,A,R,R,U)}}else if(g!==void 0){const b=g.array;S=g.version;for(let M=0,_=b.length/3-1;M<_;M+=3){const U=M+0,A=M+1,R=M+2;d.push(U,A,A,R,R,U)}}else return;const m=new(ul(d)?_l:gl)(d,1);m.version=S;const f=r.get(u);f&&e.remove(f),r.set(u,m)}function h(u){const d=r.get(u);if(d){const p=u.index;p!==null&&d.version<p.version&&l(u)}else l(u);return r.get(u)}return{get:o,update:c,getWireframeAttribute:h}}function Qp(i,e,t){let n;function s(d){n=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function c(d,p){i.drawElements(n,p,r,d*a),t.update(p,n,1)}function l(d,p,g){g!==0&&(i.drawElementsInstanced(n,p,r,d*a,g),t.update(p,n,g))}function h(d,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,d,0,g);let m=0;for(let f=0;f<g;f++)m+=p[f];t.update(m,n,1)}function u(d,p,g,S){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<d.length;f++)l(d[f]/a,p[f],S[f]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,d,0,S,0,g);let f=0;for(let b=0;b<g;b++)f+=p[b]*S[b];t.update(f,n,1)}}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function em(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function tm(i,e,t){const n=new WeakMap,s=new pt;function r(a,o,c){const l=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(o);if(d===void 0||d.count!==u){let E=function(){R.dispose(),n.delete(o),o.removeEventListener("dispose",E)};d!==void 0&&d.texture.dispose();const p=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,S=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],f=o.morphAttributes.normal||[],b=o.morphAttributes.color||[];let M=0;p===!0&&(M=1),g===!0&&(M=2),S===!0&&(M=3);let _=o.attributes.position.count*M,U=1;_>e.maxTextureSize&&(U=Math.ceil(_/e.maxTextureSize),_=e.maxTextureSize);const A=new Float32Array(_*U*4*u),R=new fl(A,_,U,u);R.type=gn,R.needsUpdate=!0;const P=M*4;for(let x=0;x<u;x++){const C=m[x],z=f[x],F=b[x],G=_*U*4*x;for(let K=0;K<C.count;K++){const V=K*P;p===!0&&(s.fromBufferAttribute(C,K),A[G+V+0]=s.x,A[G+V+1]=s.y,A[G+V+2]=s.z,A[G+V+3]=0),g===!0&&(s.fromBufferAttribute(z,K),A[G+V+4]=s.x,A[G+V+5]=s.y,A[G+V+6]=s.z,A[G+V+7]=0),S===!0&&(s.fromBufferAttribute(F,K),A[G+V+8]=s.x,A[G+V+9]=s.y,A[G+V+10]=s.z,A[G+V+11]=F.itemSize===4?s.w:1)}}d={count:u,texture:R,size:new ae(_,U)},n.set(o,d),o.addEventListener("dispose",E)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let p=0;for(let S=0;S<l.length;S++)p+=l[S];const g=o.morphTargetsRelative?1:1-p;c.getUniforms().setValue(i,"morphTargetBaseInfluence",g),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function nm(i,e,t,n){let s=new WeakMap;function r(c){const l=n.render.frame,h=c.geometry,u=e.get(c,h);if(s.get(u)!==l&&(e.update(u),s.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),s.get(c)!==l&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const d=c.skeleton;s.get(d)!==l&&(d.update(),s.set(d,l))}return u}function a(){s=new WeakMap}function o(c){const l=c.target;l.removeEventListener("dispose",o),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:a}}class El extends Ut{constructor(e,t,n,s,r,a,o,c,l,h=bi){if(h!==bi&&h!==Li)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===bi&&(n=ei),n===void 0&&h===Li&&(n=Pi),super(null,s,r,a,o,c,h,n,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:jt,this.minFilter=c!==void 0?c:jt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const bl=new Ut,dc=new El(1,1),Tl=new fl,Al=new zu,wl=new Ml,fc=[],pc=[],mc=new Float32Array(16),gc=new Float32Array(9),_c=new Float32Array(4);function Oi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=fc[s];if(r===void 0&&(r=new Float32Array(s),fc[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function vt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function xt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function nr(i,e){let t=pc[e];t===void 0&&(t=new Int32Array(e),pc[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function im(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function sm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;i.uniform2fv(this.addr,e),xt(t,e)}}function rm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(vt(t,e))return;i.uniform3fv(this.addr,e),xt(t,e)}}function am(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;i.uniform4fv(this.addr,e),xt(t,e)}}function om(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),xt(t,e)}else{if(vt(t,n))return;_c.set(n),i.uniformMatrix2fv(this.addr,!1,_c),xt(t,n)}}function cm(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),xt(t,e)}else{if(vt(t,n))return;gc.set(n),i.uniformMatrix3fv(this.addr,!1,gc),xt(t,n)}}function lm(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),xt(t,e)}else{if(vt(t,n))return;mc.set(n),i.uniformMatrix4fv(this.addr,!1,mc),xt(t,n)}}function hm(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function um(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;i.uniform2iv(this.addr,e),xt(t,e)}}function dm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(vt(t,e))return;i.uniform3iv(this.addr,e),xt(t,e)}}function fm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;i.uniform4iv(this.addr,e),xt(t,e)}}function pm(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function mm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;i.uniform2uiv(this.addr,e),xt(t,e)}}function gm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(vt(t,e))return;i.uniform3uiv(this.addr,e),xt(t,e)}}function _m(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;i.uniform4uiv(this.addr,e),xt(t,e)}}function vm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(dc.compareFunction=hl,r=dc):r=bl,t.setTexture2D(e||r,s)}function xm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Al,s)}function Mm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||wl,s)}function Sm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Tl,s)}function ym(i){switch(i){case 5126:return im;case 35664:return sm;case 35665:return rm;case 35666:return am;case 35674:return om;case 35675:return cm;case 35676:return lm;case 5124:case 35670:return hm;case 35667:case 35671:return um;case 35668:case 35672:return dm;case 35669:case 35673:return fm;case 5125:return pm;case 36294:return mm;case 36295:return gm;case 36296:return _m;case 35678:case 36198:case 36298:case 36306:case 35682:return vm;case 35679:case 36299:case 36307:return xm;case 35680:case 36300:case 36308:case 36293:return Mm;case 36289:case 36303:case 36311:case 36292:return Sm}}function Em(i,e){i.uniform1fv(this.addr,e)}function bm(i,e){const t=Oi(e,this.size,2);i.uniform2fv(this.addr,t)}function Tm(i,e){const t=Oi(e,this.size,3);i.uniform3fv(this.addr,t)}function Am(i,e){const t=Oi(e,this.size,4);i.uniform4fv(this.addr,t)}function wm(i,e){const t=Oi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Rm(i,e){const t=Oi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Cm(i,e){const t=Oi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Pm(i,e){i.uniform1iv(this.addr,e)}function Lm(i,e){i.uniform2iv(this.addr,e)}function Dm(i,e){i.uniform3iv(this.addr,e)}function Um(i,e){i.uniform4iv(this.addr,e)}function Im(i,e){i.uniform1uiv(this.addr,e)}function Nm(i,e){i.uniform2uiv(this.addr,e)}function Om(i,e){i.uniform3uiv(this.addr,e)}function Fm(i,e){i.uniform4uiv(this.addr,e)}function Bm(i,e,t){const n=this.cache,s=e.length,r=nr(t,s);vt(n,r)||(i.uniform1iv(this.addr,r),xt(n,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||bl,r[a])}function km(i,e,t){const n=this.cache,s=e.length,r=nr(t,s);vt(n,r)||(i.uniform1iv(this.addr,r),xt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Al,r[a])}function zm(i,e,t){const n=this.cache,s=e.length,r=nr(t,s);vt(n,r)||(i.uniform1iv(this.addr,r),xt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||wl,r[a])}function Gm(i,e,t){const n=this.cache,s=e.length,r=nr(t,s);vt(n,r)||(i.uniform1iv(this.addr,r),xt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Tl,r[a])}function Vm(i){switch(i){case 5126:return Em;case 35664:return bm;case 35665:return Tm;case 35666:return Am;case 35674:return wm;case 35675:return Rm;case 35676:return Cm;case 5124:case 35670:return Pm;case 35667:case 35671:return Lm;case 35668:case 35672:return Dm;case 35669:case 35673:return Um;case 5125:return Im;case 36294:return Nm;case 36295:return Om;case 36296:return Fm;case 35678:case 36198:case 36298:case 36306:case 35682:return Bm;case 35679:case 36299:case 36307:return km;case 35680:case 36300:case 36308:case 36293:return zm;case 36289:case 36303:case 36311:case 36292:return Gm}}class Hm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=ym(t.type)}}class Wm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Vm(t.type)}}class Xm{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const Dr=/(\w+)(\])?(\[|\.)?/g;function vc(i,e){i.seq.push(e),i.map[e.id]=e}function qm(i,e,t){const n=i.name,s=n.length;for(Dr.lastIndex=0;;){const r=Dr.exec(n),a=Dr.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){vc(t,l===void 0?new Hm(o,i,e):new Wm(o,i,e));break}else{let u=t.map[o];u===void 0&&(u=new Xm(o),vc(t,u)),t=u}}}class Hs{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);qm(r,a,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function xc(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Ym=37297;let Km=0;function Zm(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Mc=new Ve;function Jm(i){Ze._getMatrix(Mc,Ze.workingColorSpace,i);const e=`mat3( ${Mc.elements.map(t=>t.toFixed(4))} )`;switch(Ze.getTransfer(i)){case tr:return[e,"LinearTransferOETF"];case tt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Sc(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const a=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+Zm(i.getShaderSource(e),a)}else return s}function jm(i,e){const t=Jm(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function $m(i,e){let t;switch(e){case $h:t="Linear";break;case Qh:t="Reinhard";break;case eu:t="Cineon";break;case tu:t="ACESFilmic";break;case iu:t="AgX";break;case su:t="Neutral";break;case nu:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Us=new L;function Qm(){Ze.getLuminanceCoefficients(Us);const i=Us.x.toFixed(4),e=Us.y.toFixed(4),t=Us.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function ng(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Wi(i){return i!==""}function yc(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Ec(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const ig=/^[ \t]*#include +<([\w\d./]+)>/gm;function wa(i){return i.replace(ig,rg)}const sg=new Map;function rg(i,e){let t=We[e];if(t===void 0){const n=sg.get(e);if(n!==void 0)t=We[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return wa(t)}const ag=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function bc(i){return i.replace(ag,og)}function og(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Tc(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function cg(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===jc?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Lh?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===mn&&(e="SHADOWMAP_TYPE_VSM"),e}function lg(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Ri:case Ci:e="ENVMAP_TYPE_CUBE";break;case er:e="ENVMAP_TYPE_CUBE_UV";break}return e}function hg(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ci:e="ENVMAP_MODE_REFRACTION";break}return e}function ug(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Qa:e="ENVMAP_BLENDING_MULTIPLY";break;case Jh:e="ENVMAP_BLENDING_MIX";break;case jh:e="ENVMAP_BLENDING_ADD";break}return e}function dg(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function fg(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=cg(t),l=lg(t),h=hg(t),u=ug(t),d=dg(t),p=eg(t),g=tg(r),S=s.createProgram();let m,f,b=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+f);const M=b+m+a,_=b+f+o,U=xc(s,s.VERTEX_SHADER,M),A=xc(s,s.FRAGMENT_SHADER,_);s.attachShader(S,U),s.attachShader(S,A),t.index0AttributeName!==void 0?s.bindAttribLocation(S,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(S,0,"position"),s.linkProgram(S);function R(C){if(i.debug.checkShaderErrors){const z=s.getProgramInfoLog(S).trim(),F=s.getShaderInfoLog(U).trim(),G=s.getShaderInfoLog(A).trim();let K=!0,V=!0;if(s.getProgramParameter(S,s.LINK_STATUS)===!1)if(K=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,S,U,A);else{const te=Sc(s,U,"vertex"),H=Sc(s,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(S,s.VALIDATE_STATUS)+`
...
`,Ol="becareful-kook-lang",Fl=["en","es","pt"],Wc={en:{subtitle:"Dodge kooks, sharks, rocks and warning signs. Ride the barrel.",play:"DROP IN",language:"Language",controlsMove:"← → or hold and drag to steer",controlsJump:"↑ or swipe up — jump rocks and signs",controlsBrake:"↓ or swipe down and hold — brake for the tube",controlsPause:"❚❚ / Esc / Space / Click — pause",paused:"PAUSED",clickResume:"Tap to keep riding",pauseBtn:"Pause",replayBtn:"Restart",lives:"Lives",feet:"fts",teeth:"Shark",tubes:"Tubes",goTeethOne:"{n} shark",goTeethMany:"{n} sharks",goTubesOne:"{n} tube",goTubesMany:"{n} Tubes",cycle:"Set",level:"Level",levelUp:"LEVEL",extraLife:"+1 Life",bonusLife:"+800 fts",hakaSurf:"🤙🤙🤙",gameOver:"YOU'RE HURT",goOverRock:"You're hurt",goOverShark:"You're finished",goOverKook:"Lack of skill",goOverSign:"You're blind",hospitalWaits:"The hospital waits for you...",goRank:"You proved to be {tier}",goTierBeginner:"a beginner surfer",goTierIntermediate:"an intermediate surfer",goTierAdvanced:"an advanced surfer",goTierPro:"a pro surfer",goRock:"You cracked your head!",goShark:"You lost a leg!",goKook:"You hit a kook!",goSign:"You broke your collarbone!",restart:"SURF AGAIN",kookSpeech:"Becareful kook!!",tubeRide:"TUBE RIDE",barrel:"BARREL",stoke:"STOKE +25%",flow:"FLOW",braking:"BRAKING",distance:"Distance",bonusFeet:"+800 fts",offTheLip:"OFF THE LIP",cutback:"CUTBACK",stageWon:"YOU WON THE {place} STAGE",stageWonFinal:"YOU WON",stageOk:"OK",stageGoals:"Objectives cleared",stageGoalRide:"You covered {n}",stageGoalSurvive:"You stayed on the board",stageGoalSharkOne:"You avoid {n} shark",stageGoalSharkMany:"You avoid {n} sharks",stageGoalKookOne:"You avoid {n} kook",stageGoalKookMany:"You avoid {n} kooks",stageGoalRockOne:"You avoid {n} rock",stageGoalRockMany:"You avoid {n} rocks",stageGoalSignOne:"You avoid {n} shark warning",stageGoalSignMany:"You avoid {n} shark warnings",stageGoalTubeOne:"You rode {n} tube",stageGoalTubeMany:"You rode {n} tubes"},es:{subtitle:"Esquivá kooks, tiburones, rocas y carteles. Metete en el tubo.",play:"QUIERO SURFEAR!",language:"Idioma",controlsMove:"← → o mantené el dedo y deslizá para surfear",controlsJump:"↑ o deslizá hacia arriba — saltar las rocas y los carteles",controlsBrake:"↓ o deslizá hacia abajo y mantené — frená para el tubo",controlsPause:"❚❚ / Esc / Espacio / Click — pausa",paused:"PAUSA",clickResume:"Tocá para seguir surfeando",pauseBtn:"Pausa",replayBtn:"Empezar de nuevo",lives:"Vidas",feet:"fts",teeth:"Tiburón",tubes:"Tubos",goTeethOne:"{n} tiburón",goTeethMany:"{n} tiburones",goTubesOne:"{n} tubo",goTubesMany:"{n} Tubos",cycle:"Serie",level:"Nivel",levelUp:"NIVEL",extraLife:"+1 Vida",bonusLife:"+800 fts",hakaSurf:"🤙🤙🤙",gameOver:"ESTÁS LASTIMADO",goOverRock:"Estás lastimado",goOverShark:"Estás acabado",goOverKook:"Falta habilidad",goOverSign:"Estás ciego",hospitalWaits:"El hospital te espera...",goRank:"Demostraste ser un surfista {tier}",goTierBeginner:"principiante",goTierIntermediate:"intermedio",goTierAdvanced:"avanzado",goTierPro:"pro",restart:"SURFEAR DE NUEVO",kookSpeech:"¡Cuidado kook!!",goRock:"¡Te has partido la cabeza!",goShark:"¡Perdiste una pierna!",goKook:"¡Chocaste un kook!",goSign:"¡Te has quebrado la clavícula!",tubeRide:"TUBAAAAZO",barrel:"BARRIL",stoke:"STOKE +25%",flow:"FLOW",braking:"FRENANDO",distance:"Distancia",bonusFeet:"+800 fts",offTheLip:"OFF THE LIP",cutback:"CUTBACK",stageWon:"GANASTE LA ETAPA DE {place}",stageWonFinal:"GANASTE",stageOk:"OK",stageGoals:"Objetivos cumplidos",stageGoalRide:"Recorriste {n}",stageGoalSurvive:"Te mantuviste en la tabla",stageGoalSharkOne:"Esquivaste {n} tiburón",stageGoalSharkMany:"Esquivaste {n} tiburones",stageGoalKookOne:"Esquivaste {n} kook",stageGoalKookMany:"Esquivaste {n} kooks",stageGoalRockOne:"Esquivaste {n} roca",stageGoalRockMany:"Esquivaste {n} rocas",stageGoalSignOne:"Esquivaste {n} cartel de tiburón",stageGoalSignMany:"Esquivaste {n} carteles de tiburón",stageGoalTubeOne:"Te metiste en {n} tubo",stageGoalTubeMany:"Te metiste en {n} tubos"},pt:{subtitle:"Desvie de haoles, tubarões, pedras e placas. Entre no tubo.",play:"BORA SURFAR!",language:"Idioma",controlsMove:"← → ou segure e arraste para surfar",controlsJump:"↑ ou deslize para cima — pular as pedras e as placas",controlsBrake:"↓ ou deslize para baixo e segure — freie para o tubo",controlsPause:"❚❚ / Esc / Espaço / Clique — pausa",paused:"PAUSA",clickResume:"Toque para continuar",pauseBtn:"Pausa",replayBtn:"Recomeçar",lives:"Vidas",feet:"fts",teeth:"Tubarões",tubes:"Tubos",goTeethOne:"{n} tubarão",goTeethMany:"{n} tubarões",goTubesOne:"{n} tubo",goTubesMany:"{n} tubos",cycle:"Série",level:"Nível",levelUp:"NÍVEL",extraLife:"+1 Vida",bonusLife:"+800 fts",hakaSurf:"🤙🤙🤙",gameOver:"VOCÊ ESTÁ MACHUCADO",goOverRock:"Você está machucado",goOverShark:"Você está acabado",goOverKook:"Falta habilidade",goOverSign:"Você está cego",hospitalWaits:"O hospital espera por você...",goRank:"Você mostrou ser um surfista {tier}",goTierBeginner:"iniciante",goTierIntermediate:"intermediário",goTierAdvanced:"avançado",goTierPro:"pro",restart:"SURFEAR DE NOVO",kookSpeech:"Sai fora, haole!!",goRock:"Você quebrou a cabeça!",goShark:"Você perdeu uma perna!",goKook:"Você bateu num haole!",goSign:"Você quebrou a clavícula!",tubeRide:"TUBAAAAÇO",barrel:"BARRIL",stoke:"STOKE +25%",flow:"FLOW",braking:"FREANDO",distance:"Distância",bonusFeet:"+800 fts",offTheLip:"OFF THE LIP",cutback:"CUTBACK",stageWon:"VOCÊ GANHOU A ETAPA DE {place}",stageWonFinal:"VOCÊ GANHOU",stageOk:"OK",stageGoals:"Objetivos cumpridos",stageGoalRide:"Você percorreu {n}",stageGoalSurvive:"Você ficou na prancha",stageGoalSharkOne:"Você desviou de {n} tubarão",stageGoalSharkMany:"Você desviou de {n} tubarões",stageGoalKookOne:"Você desviou de {n} haole",stageGoalKookMany:"Você desviou de {n} haoles",stageGoalRockOne:"Você passou por {n} pedra",stageGoalRockMany:"Você passou por {n} pedras",stageGoalSignOne:"Você passou por {n} placa de tubarão",stageGoalSignMany:"Você passou por {n} placas de tubarão",stageGoalTubeOne:"Você entrou em {n} tubo",stageGoalTubeMany:"Você entrou em {n} tubos"}},Bl="pt";function ft(i,e){var t;return((t=Wc[i])==null?void 0:t[e])??Wc.en[e]??e}function kl(i){const e=String(i??"").trim().toLowerCase().split(/[-_]/)[0];return Fl.includes(e)?e:null}function J_(i=typeof window<"u"?window.location.search:""){try{const e=new URLSearchParams(i);return kl(e.get("lang")||e.get("language"))}catch{return null}}function j_(){const i=J_();if(i)return i;try{const e=localStorage.getItem(Ol);if(Fl.includes(e))return e}catch{}return Bl}function $_(i){const e=kl(i)??Bl;try{localStorage.setItem(Ol,e)}catch{}return e}function Kn(i,e,t,n){return ft(i,e===1?t:n).replaceAll("{n}",String(e))}const Xc={beginner:"goTierBeginner",intermediate:"goTierIntermediate",advanced:"goTierAdvanced",pro:"goTierPro"};function Q_(i,e){const t=ft(i,Xc[e]||Xc.beginner);return ft(i,"goRank").replaceAll("{tier}",t)}function e0(i,e,t=!1){return ft(i,t?"stageWonFinal":"stageWon").replaceAll("{place}",e??"")}function t0(i,e={}){const t=Math.max(0,e.goalDistance??0),n=[{icon:"survive",text:ft(i,"stageGoalSurvive")},{icon:"board",text:ft(i,"stageGoalRide").replaceAll("{n}",Gl(i,t,0))}],s=e.rocks??0,r=e.signs??0,a=e.teeth??0,o=e.kooks??0,c=e.tubes??0;return c>0&&n.push({icon:"tube",text:Kn(i,c,"stageGoalTubeOne","stageGoalTubeMany")}),a>0&&n.push({icon:"tooth",text:Kn(i,a,"stageGoalSharkOne","stageGoalSharkMany")}),o>0&&n.push({icon:"kook",text:Kn(i,o,"stageGoalKookOne","stageGoalKookMany")}),s>0&&n.push({icon:"rock",text:Kn(i,s,"stageGoalRockOne","stageGoalRockMany")}),r>0&&n.push({icon:"sign",text:Kn(i,r,"stageGoalSignOne","stageGoalSignMany")}),n}const n0="fts";function Oa(){return n0}function zl(i,e){return e}function Gl(i,e,t=0){return`${zl(i,e).toFixed(t)} ${Oa()}`}const i0=""+new URL("go_kook-DY_rrEgl.png",import.meta.url).href,Vl=""+new URL("go_rock-DcPmA7np.png",import.meta.url).href,s0=""+new URL("go_shark-B8mGrBc_.png",import.meta.url).href,r0=""+new URL("go_sign-JT-9Cm2T.png",import.meta.url).href,a0={shark:s0,kook:i0,rock:Vl,sign:r0},qc={board:"📏",tooth:"🦈",tube:"🌊",kook:"🏄",rock:"🪨",sign:"⚠️",survive:"🤙"};var ut,Fa,Ba,ka,za,Ga,Hl,Wl,Xl;class o0{constructor(){ri(this,ut);this.lives=document.getElementById("lives"),this.feet=document.getElementById("feet"),this.unit=document.getElementById("unit"),this.teeth=document.getElementById("teeth"),this.tubes=document.getElementById("tubes"),this.levelFlag=document.getElementById("level-flag"),this.levelNum=document.getElementById("level-num"),this.levelName=document.getElementById("level-name"),this.hud=document.getElementById("hud"),this.menu=document.getElementById("menu"),this.gameover=document.getElementById("gameover"),this.stageclear=document.getElementById("stageclear"),this.scTitle=document.getElementById("sc-title"),this.scFlag=document.getElementById("sc-flag"),this.scSpot=document.getElementById("sc-spot"),this.scOk=document.getElementById("stage-ok"),this.scGoals=document.getElementById("sc-goals"),this.pause=document.getElementById("pause"),this.scLevel=null,this.scFinal=!1,this.scStats=null,this.pauseBtn=document.getElementById("pause-btn"),this.replayBtn=document.getElementById("replay-btn"),this.speech=document.getElementById("speech"),this.speechIcon=document.getElementById("speech-icon"),this.speechText=document.getElementById("speech-text"),this.banner=document.getElementById("banner"),this.brake=document.getElementById("brake-hint"),this.buffs=document.getElementById("buffs"),this.flash=document.getElementById("hit-flash"),this.goFeet=document.getElementById("go-feet"),this.goTeeth=document.getElementById("go-teeth"),this.goTubes=document.getElementById("go-tubes"),this.goArt=document.getElementById("go-art"),this.goCaption=document.getElementById("go-caption"),this.goOcean=document.getElementById("go-ocean"),this.goHospital=document.getElementById("go-hospital"),this.goRank=document.getElementById("go-rank"),this.goCause="rock",this.goTier="beginner",this.goTeethMsg=document.getElementById("go-teeth-msg"),this.goTubesMsg=document.getElementById("go-tubes-msg"),this.langBtns=[...document.querySelectorAll("[data-lang]")],document.querySelectorAll("[data-stat-icon]").forEach(e=>{e.innerHTML=qc[e.dataset.statIcon]||""})}setLang(e){document.querySelectorAll("[data-i18n]").forEach(t=>{t.textContent=ft(e,t.dataset.i18n)}),document.querySelectorAll("[data-i18n-aria]").forEach(t=>{t.setAttribute("aria-label",ft(e,t.dataset.i18nAria))}),this.langBtns.forEach(t=>{t.classList.toggle("on",t.dataset.lang===e)}),this.lang=e,document.documentElement.lang=e,this.unit&&(this.unit.textContent=Oa()),j(this,ut,Ba).call(this),j(this,ut,ka).call(this),j(this,ut,za).call(this),j(this,ut,Ga).call(this)}showMenu(){var e;this.menu.classList.remove("hidden"),this.gameover.classList.add("hidden"),(e=this.stageclear)==null||e.classList.add("hidden"),this.pause.classList.add("hidden"),this.hud.classList.add("hidden")}showPlay(){var e;this.menu.classList.add("hidden"),this.gameover.classList.add("hidden"),(e=this.stageclear)==null||e.classList.add("hidden"),this.pause.classList.add("hidden"),this.hud.classList.remove("hidden")}showPause(){this.pause.classList.remove("hidden")}hidePause(){this.pause.classList.add("hidden")}showStageClear(e,{final:t=!1,...n}={}){var r,a,o,c;this.scLevel=e,this.scFinal=t,this.scStats=n,this.hud.classList.add("hidden"),this.pause.classList.add("hidden"),this.menu.classList.add("hidden"),this.gameover.classList.add("hidden"),(r=this.stageclear)==null||r.classList.remove("hidden"),j(this,ut,Ga).call(this),(a=this.banner)==null||a.classList.add("hidden"),(o=this.speech)==null||o.classList.add("hidden");const s=document.getElementById("sc-trophy");s&&(s.style.animation="none",s.offsetHeight,s.style.animation=""),(c=this.scOk)==null||c.focus()}showGameOver(e){var s;this.hud.classList.add("hidden"),this.pause.classList.add("hidden"),(s=this.stageclear)==null||s.classList.add("hidden"),this.gameover.classList.remove("hidden"),this.goFeet.textContent=Gl(this.lang,e.feet,0),this.goTeeth.textContent=String(e.teeth),this.goTubes.textContent=String(e.tubes),this.goTeethMsg&&(this.goTeethMsg.textContent=Kn(this.lang,e.teeth,"goTeethOne","goTeethMany")),this.goTubesMsg&&(this.goTubesMsg.textContent=Kn(this.lang,e.tubes,"goTubesOne","goTubesMany"));const t=a0[e.cause]||Vl;this.goArt.replaceChildren();const n=document.createElement("img");n.src=t,n.alt="",this.goArt.append(n),this.goCause=e.cause,this.goTier=e.tier||"beginner",j(this,ut,Ba).call(this),j(this,ut,ka).call(this),j(this,ut,za).call(this),this.goHospital&&(this.goHospital.textContent=ft(this.lang,"hospitalWaits"))}update(e){var n;this.feet.textContent=String(Math.floor(e.displayDistance)),this.unit.textContent=Oa(),this.teeth.textContent=String(e.teeth),this.tubes&&(this.tubes.textContent=String(e.tubes??0)),this.levelFlag&&(this.levelFlag.textContent=e.levelFlag||""),this.levelNum.textContent=String(e.levelId),this.levelName.textContent=e.levelName??"";const t=(n=this.levelFlag)==null?void 0:n.parentElement;t&&t.setAttribute("aria-label",`${e.levelId} ${e.levelName??""}`.trim()),j(this,ut,Wl).call(this,e.lives,e.lifeBlink),this.brake.classList.toggle("hidden",!e.braking),this.brake.textContent=ft(this.lang,"braking"),j(this,ut,Xl).call(this,e)}placeSpeech(e,t=1100,n=""){this.speechText.textContent=e,n?(this.speechIcon.innerHTML=n,this.speechIcon.classList.remove("hidden")):(this.speechIcon.innerHTML="",this.speechIcon.classList.add("hidden")),this.speech.classList.remove("hidden"),this.speech.style.left="",this.speech.style.top="",clearTimeout(this._speechTimer),this._speechTimer=setTimeout(()=>this.speech.classList.add("hidden"),t)}showBanner(e){this.banner.replaceChildren(),this.banner.textContent=e,j(this,ut,Fa).call(this,1200)}showLevelBanner(e){const t=document.createElement("div");t.className="banner-line",t.textContent=`${ft(this.lang,"levelUp")} ${e.id}`;const n=document.createElement("div");n.className="banner-wave";const s=document.createElement("span");s.className="banner-flag",s.textContent=Da(e.wave);const r=document.createElement("span");r.textContent=La(e.wave,this.lang),n.append(s,r),this.banner.replaceChildren(t,n),j(this,ut,Fa).call(this,1700)}hitFlash(){this.flash.classList.add("on"),setTimeout(()=>this.flash.classList.remove("on"),140)}}ut=new WeakSet,Fa=function(e){this.banner.classList.remove("hidden"),this.banner.style.animation="none",this.banner.offsetHeight,this.banner.style.animation="",this.banner.style.color="black",clearTimeout(this._bannerTimer),this._bannerTimer=setTimeout(()=>this.banner.classList.add("hidden"),e)},Ba=function(){const e={shark:"goOverShark",kook:"goOverKook",rock:"goOverRock",sign:"goOverSign"};this.goCaption&&(this.goCaption.textContent=ft(this.lang,e[this.goCause]||"goOverRock"))},ka=function(){const e={shark:"goShark",kook:"goKook",rock:"goRock",sign:"goSign"};this.goOcean&&(this.goOcean.textContent=ft(this.lang,e[this.goCause]||"goRock"))},za=function(){this.goRank&&(this.goRank.textContent=Q_(this.lang,this.goTier))},Ga=function(){if(!this.scTitle||!this.scLevel)return;const e=La(this.scLevel.wave,this.lang);this.scTitle.textContent=e0(this.lang,e,this.scFinal),this.scFlag&&(this.scFlag.textContent=Da(this.scLevel.wave)),this.scSpot&&(this.scSpot.textContent=L_(this.scLevel.wave,this.lang)),j(this,ut,Hl).call(this)},Hl=function(){if(!this.scGoals)return;const e=t0(this.lang,this.scStats??{});this.scGoals.replaceChildren(...e.map(t=>{const n=typeof t=="string"?t:t.text,s=typeof t=="string"?"":t.icon,r=document.createElement("li"),a=document.createElement("span");a.className="sc-tick",a.textContent="✓",a.setAttribute("aria-hidden","true");const o=qc[s];if(o){const l=document.createElement("span");l.className="sc-goal-icon",l.setAttribute("aria-hidden","true"),l.innerHTML=o,r.append(l)}const c=document.createElement("span");return c.textContent=n,r.append(c),r}))},Wl=function(e,t=-1){const n=Math.max(0,Math.min(Ws,e|0));this.lives.childElementCount!==Ws&&this.lives.replaceChildren(...Array.from({length:Ws},()=>{const a=document.createElement("span");return a.className="wave-life",a.innerHTML=Na,a}));const s=t>=0&&t<Ia,r=s?Math.floor(t*12)%2===0:!0;[...this.lives.children].forEach((a,o)=>{const c=o<n,l=s&&c&&o===n-1;a.classList.toggle("on",c),a.classList.toggle("blink",l),l?a.style.opacity=r?"1":"0":a.style.opacity=""})},Xl=function(e){const t=[];e.stoke>0&&t.push(`<div class="buff">${ft(this.lang,"stoke")}</div>`),e.flow>0&&t.push(`<div class="buff">${ft(this.lang,"flow")}</div>`),this.buffs.innerHTML=t.join("")};const c0=.155,kr=.025,Yc=.12,l0=.1;function Kc(i){return i==="touch"||i==="pen"}function h0(i,e,t){return Math.max(e,Math.min(t,i))}function u0(i){const e=Math.abs(i);if(e<=kr)return 0;const t=(e-kr)/(c0-kr);return Math.sign(i)*h0(t,0,1)}var mt,Wn,Va,Ha,ql,Yl,Kl;class d0{constructor(){ri(this,mt);this.left=!1,this.right=!1,this.up=!1,this.down=!1,this.axis=0,this.touching=!1,this.jumpPressed=!1,this._jumpLatch=!1,this._jumpQueued=!1,this._keys={left:!1,right:!1,up:!1,down:!1},this._pointers=new Map,this.canvas=null,this._onKeyDown=e=>j(this,mt,Va).call(this,e.code,!0,e),this._onKeyUp=e=>j(this,mt,Va).call(this,e.code,!1,e),this._onPointerDown=e=>j(this,mt,ql).call(this,e),this._onPointerMove=e=>j(this,mt,Yl).call(this,e),this._onPointerUp=e=>j(this,mt,Kl).call(this,e),this._onContext=e=>e.preventDefault(),this._onTouch=e=>e.preventDefault()}attach(e){this.canvas=e,window.addEventListener("keydown",this._onKeyDown),window.addEventListener("keyup",this._onKeyUp),e.addEventListener("pointerdown",this._onPointerDown),e.addEventListener("pointermove",this._onPointerMove),e.addEventListener("pointerup",this._onPointerUp),e.addEventListener("pointercancel",this._onPointerUp),e.addEventListener("lostpointercapture",this._onPointerUp),e.addEventListener("contextmenu",this._onContext),e.addEventListener("touchstart",this._onTouch,{passive:!1}),e.addEventListener("touchmove",this._onTouch,{passive:!1})}detach(){window.removeEventListener("keydown",this._onKeyDown),window.removeEventListener("keyup",this._onKeyUp),this.canvas&&(this.canvas.removeEventListener("pointerdown",this._onPointerDown),this.canvas.removeEventListener("pointermove",this._onPointerMove),this.canvas.removeEventListener("pointerup",this._onPointerUp),this.canvas.removeEventListener("pointercancel",this._onPointerUp),this.canvas.removeEventListener("lostpointercapture",this._onPointerUp),this.canvas.removeEventListener("contextmenu",this._onContext),this.canvas.removeEventListener("touchstart",this._onTouch),this.canvas.removeEventListener("touchmove",this._onTouch))}beginFrame(){j(this,mt,Wn).call(this),this.jumpPressed=this.up&&!this._jumpLatch||this._jumpQueued,this._jumpLatch=this.up,this._jumpQueued=!1}reset(){this._keys.left=this._keys.right=this._keys.up=this._keys.down=!1,this.clearPointers(),this.jumpPressed=this._jumpLatch=this._jumpQueued=!1,this.axis=0,this.touching=!1}clearPointers(){this._pointers.clear(),j(this,mt,Wn).call(this)}}mt=new WeakSet,Wn=function(){let e=0,t=!1,n=!1,s=!1,r=null;for(const o of this._pointers.values())Kc(o.type)&&(s=!0,r||(r=o),o.startNy-o.ny>Yc&&(t=!0));r&&(e=u0(r.nx-r.startNx),r.ny-r.startNy>l0&&(n=!0));const a=(this._keys.right?1:0)-(this._keys.left?1:0);this.axis=a!==0?a:e,this.left=this.axis<0,this.right=this.axis>0,this.up=this._keys.up||t,this.down=this._keys.down||n,this.touching=s&&a===0},Va=function(e,t,n){const r={ArrowLeft:"left",ArrowRight:"right",ArrowUp:"up",ArrowDown:"down",KeyA:"left",KeyD:"right",KeyW:"up",KeyS:"down"}[e];r&&(n.preventDefault(),this._keys[r]=t,r==="up"&&t&&(this._jumpQueued=!0),j(this,mt,Wn).call(this))},Ha=function(e){const t=this.canvas.getBoundingClientRect(),n=Math.max(1,t.width),s=Math.max(1,t.height);return{nx:(e.clientX-t.left)/n,ny:(e.clientY-t.top)/s}},ql=function(e){if(!Kc(e.pointerType))return;e.preventDefault(),this.canvas.setPointerCapture(e.pointerId);const t=j(this,mt,Ha).call(this,e);this._pointers.set(e.pointerId,{...t,startNx:t.nx,startNy:t.ny,jumped:!1,type:e.pointerType}),j(this,mt,Wn).call(this)},Yl=function(e){if(!this._pointers.has(e.pointerId))return;const t=this._pointers.get(e.pointerId),n=j(this,mt,Ha).call(this,e),s=t.jumped||t.startNy-n.ny>Yc;!t.jumped&&s&&(this._jumpQueued=!0),this._pointers.set(e.pointerId,{...n,startNx:t.startNx,startNy:t.startNy,jumped:s,type:t.type}),j(this,mt,Wn).call(this)},Kl=function(e){this._pointers.has(e.pointerId)&&(this._pointers.delete(e.pointerId),j(this,mt,Wn).call(this))};const ct=i=>new vo({color:i,emissive:i,emissiveIntensity:.08});function Jt(i){return i.castShadow=!0,i.receiveShadow=!0,i}function f0(i,e){const t=new hs;t.moveTo(0,.92),t.bezierCurveTo(.16,.88,.36,.52,.4,.05),t.lineTo(.44,-.38),t.lineTo(.36,-.78),t.lineTo(.22,-1.22),t.lineTo(0,-.72),t.lineTo(-.22,-1.22),t.lineTo(-.36,-.78),t.lineTo(-.44,-.38),t.lineTo(-.4,.05),t.bezierCurveTo(-.36,.52,-.16,.88,0,.92);const n=new Qn(t,{depth:.07,bevelEnabled:!0,bevelThickness:.016,bevelSize:.018,bevelSegments:3});n.center();const s=new Le(n,ct(i));s.rotation.x=-Math.PI/2,s.position.y=.06,s.name="deck",Jt(s);const r=new Le(new nn(.045,1.55,6,10),ct(e));r.rotation.x=Math.PI/2,r.position.y=.12;const a=ct("#1d3557"),o=new Le(new $n(.08,.26,8),a);o.position.set(-.12,-.02,.78),o.rotation.z=.18;const c=o.clone();c.position.x=.12,c.rotation.z=-.18;const l=ct(i),h=new Le(new $n(.13,.38,3),l);h.rotation.set(Math.PI/2,0,.45),h.position.set(-.18,.06,1.08);const u=h.clone();u.rotation.z=-.45,u.position.x=.18;const d=new gt;return d.name="board",d.add(s,r,o,c,h,u),d}function p0(){const i=new gt;i.name="shaka";const e=ct("#f4a261"),t=new Le(new Et(.09,8,6),e),n=new Le(new nn(.032,.22,3,6),e);n.position.set(-.11,.12,.03),n.rotation.z=1.05;const s=new Le(new nn(.028,.24,3,6),e);s.position.set(.11,.14,.03),s.rotation.z=-.7;const r=new Le(new Et(.07,10,8),e);return r.position.set(.01,-.02,0),i.add(t,n,s,r),i.position.set(0,.48,0),i.scale.setScalar(1.35),i.visible=!1,i}function Zl(){const i=new gt;i.name="player";const e=f0("#ffd166","#e53935"),t=ct("#f4a261"),n=new Le(new Et(.07,10,8),t);n.scale.set(1,.55,1.35),n.position.set(-.11,.12,.04);const s=n.clone();s.position.x=.11;const r=new Le(new nn(.075,.42,6,12),t);r.position.set(-.11,.38,0),Jt(r);const a=r.clone();a.position.x=.11;const o=new Le(new nn(.22,.48,8,16),ct("#06d6a0"));o.position.y=.98,o.name="torso",Jt(o);const c=new Le(new Et(.23,20,16),t);c.position.y=1.48,Jt(c);const l=new Le(new Et(.21,16,12),ct("#3d2914"));l.position.set(0,1.61,-.02);const h=new Le(new Et(.045,12,10),ct("#1b1b1b"));h.position.set(-.08,1.52,.18);const u=h.clone();u.position.x=.08;const d=new gt;d.name="armL",d.position.set(-.32,1.12,0);const p=new Le(new nn(.07,.32,6,12),t);p.position.y=-.18,d.rotation.z=.28,d.add(p);const g=new gt;g.name="armR",g.position.set(.32,1.12,0);const S=new Le(new nn(.07,.32,6,12),t);S.position.y=-.18,g.rotation.z=-.28,g.add(S,p0());const m=new gt;m.name="rider",m.add(n,s,r,a,o,c,l,h,u,d,g);const f=new Le(new go(.55,16),new Un({color:"#06283a",transparent:!0,opacity:.28}));return f.rotation.x=-Math.PI/2,f.position.y=.02,f.name="blob",i.add(e,m,f),i}function m0(){const i=Zl();i.name="kook";const e=i.getObjectByName("deck");e&&(e.material=ct("#e53935"));const t=i.getObjectByName("torso");t&&(t.material=ct("#ffd166"));const n=i.getObjectByName("shaka");return n&&(n.visible=!1),i}function g0(){const i=new gt,e=ct("#8d6e63"),t=new Le(new Qs(.68,1),e);t.scale.set(1.15,.78,.95);const n=new Le(new Qs(.4,1),ct("#6d4c41"));return n.position.set(.32,.12,.08),Jt(t),Jt(n),i.add(t,n),i.position.y=.28,i}function _0(){const i=new gt,e=ct("#5d737e"),t=new Le(new Et(.55,18,14),e);t.scale.set(.7,.7,2.2),t.position.y=.55,Jt(t);const n=new Le(new $n(.22,.7,10),ct("#4a5d66"));n.position.set(0,1.15,.1);const s=new Le(new $n(.28,.7,10),e);s.rotation.x=Math.PI/2,s.position.set(0,.55,1.35);const r=new Le(new Et(.07,8,8),ct("#111"));r.position.set(.22,.7,-.85);const a=r.clone();a.position.x=-.22;const o=new gt;o.position.set(0,.42,-1.12);const c=new Le(new Et(.22,10,8),ct("#2a1014"));c.scale.set(1.05,.7,.85);const l=new Le(new nn(.16,.18,6,10),ct("#4a5d66"));l.position.set(0,-.16,-.02),l.rotation.x=.35;const h=new Le(new Et(.13,8,6),ct("#ff4d6d"));h.scale.set(.72,.38,2.35),h.position.set(0,-.05,-.32),o.add(c,l,h);const u=ct("#f7f1e1");for(let d=0;d<7;d+=1){const p=new Le(new $n(.048,.2,5),u);p.position.set(-.2+d*.066,.14,-.12),p.rotation.x=Math.PI;const g=p.clone();g.position.y=-.12,g.rotation.x=0,o.add(p,g)}return i.add(t,n,s,r,a,o),i.rotation.y=Math.PI,i}function Zc(i,e){const t=new hs,n=i/2,s=Math.min(e,n*.45);return t.moveTo(-n+s,-n),t.lineTo(n-s,-n),t.quadraticCurveTo(n,-n,n,-n+s),t.lineTo(n,n-s),t.quadraticCurveTo(n,n,n-s,n),t.lineTo(-n+s,n),t.quadraticCurveTo(-n,n,-n,n-s),t.lineTo(-n,-n+s),t.quadraticCurveTo(-n,-n,-n+s,-n),t.closePath(),t}function v0(){const i=new hs;return i.moveTo(-.2,-.06),i.quadraticCurveTo(-.16,.16,.04,.4),i.lineTo(.3,-.05),i.quadraticCurveTo(.08,.02,-.2,-.06),i.closePath(),i}function zr(i,e,t){const n=[];for(let s=0;s<=12;s+=1){const r=s/12;n.push(new L(-.34+r*.68,i+Math.sin(r*Math.PI*2+t)*e,0))}return new sr(new po(n),24,.028,6,!1)}function x0(){const i=new gt;i.name="sign";const e=new vo({color:"#f4c430",emissive:"#f4c430",emissiveIntensity:.18}),t=ct("#141414"),n=ct("#5b4636"),s=ct("#8a5a32"),r=new Le(new jn(.16,.22,.12,10),s);r.position.y=.04,Jt(r);const a=new Le(new jn(.055,.065,.92,8),n);a.position.y=.52,Jt(a);const o=new Le(new jn(.08,.08,.07,8),s);o.position.y=.96;const c=new gt;c.position.y=1.18;const l=new Qn(Zc(1.12,.12),{depth:.14,bevelEnabled:!0,bevelThickness:.025,bevelSize:.02,bevelSegments:2});l.translate(0,0,-.07);const h=new Le(l,t);h.rotation.z=Math.PI/4,Jt(h);const u=new Qn(Zc(.92,.1),{depth:.16,bevelEnabled:!0,bevelThickness:.02,bevelSize:.018,bevelSegments:2});u.translate(0,0,-.05);const d=new Le(u,e);d.rotation.z=Math.PI/4,Jt(d);const p=new gt;p.position.z=.12;const g=new Qn(v0(),{depth:.07,bevelEnabled:!0,bevelThickness:.012,bevelSize:.01,bevelSegments:1});g.translate(0,0,-.035);const S=new Le(g,t);return S.position.set(-.02,.08,0),p.add(S),p.add(new Le(zr(-.12,.045,.2),t),new Le(zr(-.22,.04,1.1),t),new Le(zr(-.32,.035,.5),t)),c.add(h,d,p),i.add(r,a,o,c),i}function Xs(i,e,t=1.32,n=1.88){const s=-.38*Math.PI+i*1.38*Math.PI;return{x:t+Math.cos(s)*e*1.12,y:n+Math.sin(s)*e*.96}}function M0(i,e,t=.3,n=.98){const s=new hs,r=40,a=Xs(t,i);s.moveTo(a.x,a.y);for(let o=1;o<=r;o+=1){const c=Xs(t+(n-t)*(o/r),i);s.lineTo(c.x,c.y)}for(let o=r;o>=0;o-=1){const c=Xs(t+(n-t)*(o/r),e);s.lineTo(c.x,c.y)}return s.closePath(),s}function S0(){return new $t({uniforms:{uTime:{value:0},uReady:{value:0}},side:Vt,transparent:!1,vertexShader:`
      uniform float uTime;
      varying vec3 vPos;
      varying vec3 vN;
      void main() {
    ...
    `})}function y0(){const i=new gt,e=8.4,t=S0(),n=new Qn(M0(2.55,1.18),{depth:e,bevelEnabled:!0,bevelThickness:.28,bevelSize:.2,bevelSegments:3,curveSegments:16});n.translate(0,0,-e/2),n.computeVertexNormals();const s=new Le(n,t);s.name="waveBody";const r=new Le(new Et(1.35,18,14,0,Math.PI*2,0,Math.PI*.5),new vo({color:"#042e28",side:Lt}));r.scale.set(1.2,.78,2.6),r.position.set(.7,2.35,0),r.rotation.z=-.12;const a=new gt;a.name="foamClaws";const o=Xs(.48,2.62),c=new po([new L(o.x,o.y-.05,-3.6),new L(o.x+.2,o.y+.28,0),new L(o.x,o.y-.02,3.6)]);a.add(new Le(new sr(c,32,.38,10,!1),new Un({color:"#f8fdff"})));const l=new Un({color:"#f4fbff"});for(let h=0;h<14;h+=1){const u=c.getPoint(h/13),d=new Le(new Et(.14+h%3*.05,8,6),l);d.position.set(u.x+.06,u.y+.16,u.z),d.scale.set(1.4,.65,1.1),a.add(d)}return i.add(s,r,a),i}function an(i){const e=Math.max(0,Math.min(1.12,(i+5.8)/12.2));return .18+e*e*4.6}function So(i){return(an(i+.25)-an(i-.25))/.5}function E0(){const i=new Ni(26,220,70,90);i.rotateX(-Math.PI/2);const e=i.attributes.position;for(let r=0;r<e.count;r+=1){const a=e.getX(r);e.setY(r,an(a))}i.computeVertexNormals();const t={uTime:{value:0},uOffset:{value:0}},n=new $t({uniforms:t,side:Vt,vertexShader:`
      uniform float uTime;
    ...
    `}),s=new Le(i,n);return s.position.set(0,0,-40),s.receiveShadow=!0,s.name="water",s}function b0(){const i=new Ni(220,7.5,80,16),e={uTime:{value:0},uOffset:{value:0}},t=new $t({uniforms:e,side:Vt,vertexShader:`
      uniform float uTime;
      uniform float uOffset;
      varying vec2 vUv;
      void main() {
    ...
    `}),n=new Le(i,t);n.rotation.y=-Math.PI/2,n.rotation.z=.55;const s=8.4;return n.position.set(s,an(s)+2.4,-50),n}function T0(){const i=new jn(.62,.95,220,10,1);i.rotateX(Math.PI/2);const e=new Un({color:"#f8fdff"}),t=new Le(i,e),n=7.15;return t.position.set(n,an(n)+.45,-40),t.rotation.z=-Math.atan(So(n)),t}function A0(){const i=new gt,e=new Le(new Et(3.2,24,18),new Un({color:"#ffd56a"}));return e.position.set(-18,16,-70),i.add(e),i}function w0(){const i=new gt,e=new Un({color:"#f4fbff"});for(let t=0;t<8;t+=1){const n=new gt,s=new Le(new Et(1.6,14,12),e),r=new Le(new Et(1.2,14,12),e);r.position.set(1.4,.25,.15),n.add(s,r),n.position.set(-18+t%4*11,12+t%3*1.4,-36-t*14),i.add(n)}return i}const Jc={rock:.28,shark:0,kook:0,tube:0,sign:0},R0={rock:g0,shark:_0,kook:m0,tube:y0,sign:x0},C0={rock:{w:1.35,h:.9,d:1.3,jumpable:!0},shark:{w:1.15,h:2.4,d:2.6,jumpable:!1},kook:{w:.9,h:1.5,d:1.8,jumpable:!1},tube:{w:2.8,h:3.2,d:3,jumpable:!1},sign:{w:1.2,h:1.55,d:.55,jumpable:!0}};var Tt,Jl,jl,Wa,$l,Ql,eh,th;class P0{constructor(e){ri(this,Tt);this.scene=e,this.items=[],this.nextAt=22,this.lastWasTube=!1}reset(){for(const e of this.items)this.scene.remove(e.mesh);this.items=[],this.nextAt=22,this.lastWasTube=!1}spawnNow(e,t=0){j(this,Tt,Wa).call(this,e,t)}update(e,t,n,s,r,a=1,o=!1){j(this,Tt,Jl).call(this,n,a,o);const c=[];for(const l of this.items){if(l.z+=t*e,l.mesh.position.z=l.z,j(this,Tt,$l).call(this,l,e,s),l.type==="tube"&&j(this,Tt,Ql).call(this,l,s),!l.resolved&&l.type==="tube"){const h=Math.abs(s.x-l.x);Math.abs(l.z)<2.6&&h<2.15&&(l.resolved=!0,r.onTube(!0))}!l.resolved&&Math.abs(l.z)<l.size.d*.55&&j(this,Tt,eh).call(this,l,s,r),!l.resolved&&l.z>1.4&&(j(this,Tt,th).call(this,l,s,r),l.resolved=!0),l.z>z_?this.scene.remove(l.mesh):c.push(l)}this.items=c}}Tt=new WeakSet,Jl=function(e,t=1,n=!1){if(e<this.nextAt)return;const s=(32+Math.random()*18)*t;this.nextAt=e+s;const r=n?k_:.12,a=Math.random()<r?2:1,o=[];for(let c=0;c<a;c+=1){const l=j(this,Tt,jl).call(this,a>1);if(!l)continue;let h=yt.randFloatSpread(8.4);for(l==="tube"&&(h=yt.randFloatSpread(2.6));o.some(u=>Math.abs(u-h)<2.2);)h=yt.randFloatSpread(8.4);o.push(h),j(this,Tt,Wa).call(this,l,h)}},jl=function(e){if(!e&&!this.lastWasTube&&Math.random()<.07)return this.lastWasTube=!0,"tube";this.lastWasTube=!1;const t=Math.random();return t<.32?"rock":t<.46?"sign":t<.72?"shark":"kook"},Wa=function(e,t){const n=R0[e]();n.position.set(t,an(t)+(Jc[e]??0),Gc),this.scene.add(n);const s=C0[e];this.items.push({type:e,mesh:n,x:t,z:Gc,size:s,hit:!1,resolved:!1,brakeValid:!1,approached:!1,glow:0})},$l=function(e,t,n){var a;const s=-Math.atan(So(e.x)),r=an(e.x)+(Jc[e.type]??0);if(e.mesh.rotation.z=s,e.type==="shark"?(e.mesh.position.y=r+.15+Math.sin(e.z*.2)*.12,e.mesh.rotation.z=s+Math.sin(e.z*.15)*.08):e.mesh.position.y=r,e.type==="kook"){const o=e.mesh.getObjectByName("rider");o&&(o.rotation.z=Math.sin(e.z*.35)*.35),e.mesh.rotation.y=Math.sin(e.z*.2)*.15}if(e.type==="tube"){const o=e.mesh.getObjectByName("foamClaws");o&&(o.rotation.z=Math.sin(e.z*.18)*.04);const c=e.mesh.getObjectByName("waveBody");if((a=c==null?void 0:c.material)!=null&&a.uniforms){const l=Math.abs(n.x-e.x)<2.15&&e.z>-30;c.material.uniforms.uReady.value=l?1:0,c.material.uniforms.uTime.value=Math.abs(e.z)*.08}}},Ql=function(e,t){!e.approached&&e.z>=G_&&(e.approached=!0,e.brakeValid=t.braking),e.approached&&!t.braking&&(e.brakeValid=!1)},eh=function(e,t,n){const s=Math.abs(t.x-e.x),r=Math.abs(t.z-e.z),a=t.y,o=s<(.7+e.size.w)*.5,c=r<(1.6+e.size.d)*.5;if(!(!o||!c)){if(e.type==="rock"||e.type==="sign"){if(a>.85)return;e.hit=!0,e.resolved=!0,n.onHazard(e);return}if(e.type==="shark"){e.hit=!0,e.resolved=!0,n.onHazard(e);return}e.type==="kook"&&(e.hit=!0,e.resolved=!0,n.onHazard(e))}},th=function(e,t,n){var s,r;e.hit||(e.type==="shark"&&n.onSharkDodge(),e.type==="kook"&&n.onKookDodge(),e.type==="rock"&&((s=n.onRockDodge)==null||s.call(n)),e.type==="sign"&&((r=n.onSignDodge)==null||r.call(n)))};const L0=Ua-.1,D0=Xi+.1;var it,Xa,qs,nh,ih,qa,Ya,sh,rh,Ys;class U0{constructor(){ri(this,it);this.mesh=Zl(),this.x=0,this.y=0,this.z=0,this.vx=0,this.vy=0,this.grounded=!0,this.braking=!1,this.invuln=0,this.blink=0,this.haka=0,this.spin=0,this.spinVel=0,this.returning=0,this.lipReady=!0,this.cutReady=!0,this.maneuverEvent=null,this.cutLean=0,j(this,it,Ya).call(this)}reset(){this.x=0,this.y=0,this.vx=0,this.vy=0,this.grounded=!0,this.braking=!1,this.invuln=0,this.haka=0,this.spin=0,this.spinVel=0,this.returning=0,this.lipReady=!0,this.cutReady=!0,this.maneuverEvent=null,this.cutLean=0,this.mesh.visible=!0,this.mesh.rotation.set(0,0,0),j(this,it,Ya).call(this),j(this,it,Ys).call(this,!1),j(this,it,qa).call(this)}consumeManeuver(){const e=this.maneuverEvent;return this.maneuverEvent=null,e}update(e,t,n){if(this.braking=t.down&&this.returning===0,this.x<Ua*.35&&(this.lipReady=!0),this.x>Xi*.35&&(this.cutReady=!0),this.returning===0&&this.lipReady&&this.grounded&&this.x>=L0&&j(this,it,nh).call(this),this.returning===0&&this.cutReady&&this.grounded&&this.x<=D0&&j(this,it,ih).call(this),this.returning<0)this.vx=yt.damp(this.vx,-Gn,18,e),this.x+=this.vx*e,this.x<=0&&(this.x=0,this.vx=0,this.grounded&&j(this,it,qs).call(this));else if(this.returning>0)this.vx=yt.damp(this.vx,Gn,18,e),this.x+=this.vx*e,this.x>=0&&j(this,it,qs).call(this);else{const r=t.axis??(t.right?1:0)-(t.left?1:0);if(!!t.touching){const o=Gn*O_;this.vx=yt.damp(this.vx,r*o,F_,e)}else r!==0?this.vx+=r*I_*e:this.vx=yt.damp(this.vx,0,N_,e),this.vx=yt.clamp(this.vx,-Gn,Gn);this.x=yt.clamp(this.x+this.vx*e,Xi,Ua)}t.jumpPressed&&this.grounded&&this.returning===0&&j(this,it,Xa).call(this),this.grounded||(this.vy-=zc*e,this.y+=this.vy*e,this.spin+=this.spinVel*e,this.y<=0&&(this.y=0,this.vy=0,this.grounded=!0,this.spin=0,this.spinVel=0,this.returning<0&&this.x<=0&&j(this,it,qs).call(this)));const s=this.returning>0?1:0;this.cutLean=yt.damp(this.cutLean,s,10,e),this.invuln>0?(this.invuln-=e,this.blink+=e,this.mesh.visible=Math.floor(this.blink*12)%2===0):this.mesh.visible=!0,this.haka>0&&(this.haka=Math.max(0,this.haka-e),j(this,it,Ys).call(this,this.haka>0)),j(this,it,qa).call(this,n)}celebrateHaka(e=1.8){this.haka=e,j(this,it,Ys).call(this,!0)}hit(){this.invuln=1.15,this.blink=0,this.vx+=this.x>0?-4:4,this.returning=0,this.cutLean=0}bumpFrom(e){this.vx+=this.x>=e?6:-6}headWorld(){return new L(this.x,an(this.x)+this.y+1.85,this.z)}}it=new WeakSet,Xa=function(e=kc){this.vy=e,this.grounded=!1,this.spin=0;const t=2*e/zc;this.spinVel=Math.PI*2/Math.max(.35,t)},qs=function(){this.x=0,this.vx=0,this.returning=0,this.cutLean=0},nh=function(){this.lipReady=!1,this.returning=-1,this.maneuverEvent="lip",j(this,it,Xa).call(this,kc*1.18),this.vx=-Gn},ih=function(){this.cutReady=!1,this.returning=1,this.maneuverEvent="cutback",this.vx=Gn},qa=function(e=0){const t=this.grounded?Math.sin(e*9)*.03:0,n=an(this.x),s=Math.atan(So(this.x)),r=this.returning>0?yt.clamp((this.x-Xi)/-Xi,0,1):0,a=Math.sin(r*Math.PI)*this.cutLean;this.mesh.position.set(this.x,n+this.y+t,this.z),this.mesh.rotation.z=-s+(this.grounded?-a*.7:Math.sin(this.spin)*.28),this.mesh.rotation.y=this.grounded?yt.lerp(this.mesh.rotation.y,a*1.25,.22):this.spin,this.mesh.rotation.x=this.grounded?yt.lerp(this.mesh.rotation.x,a*.18,.22):Math.sin(this.spin*.5)*.45;const o=this.mesh.getObjectByName("board"),c=this.mesh.getObjectByName("rider");if(o){const h=this.returning>0?-a*.45:-this.vx*.05;o.rotation.z=yt.lerp(o.rotation.z,h,.2),o.rotation.x=this.braking?.18:this.grounded?a*.12:-.35}c&&(c.rotation.y=Math.PI,c.rotation.z=-this.vx*.03-a*.35,c.position.y=this.braking?-.08:this.grounded?0:.06);const l=this.mesh.getObjectByName("blob");l&&(l.position.y=-this.y+.02,l.scale.setScalar(this.grounded?1+a*.35:.7)),this.haka<=0&&(this.returning>0?j(this,it,rh).call(this,a):j(this,it,sh).call(this,!this.grounded))},Ya=function(){const e=this.mesh.getObjectByName("rider");e&&(e.rotation.y=Math.PI)},sh=function(e){const t=this.mesh.getObjectByName("armL"),n=this.mesh.getObjectByName("armR");t&&(t.rotation.z=e?1.35:.28),n&&(n.rotation.z=e?-1.45:-.28,n.rotation.x=e?.25:0,n.rotation.y=0)},rh=function(e){const t=this.mesh.getObjectByName("armL"),n=this.mesh.getObjectByName("armR");t&&(t.rotation.z=.28+e*1.1),n&&(n.rotation.z=-.55-e*.8,n.rotation.x=e*.35,n.rotation.y=-e*.4)},Ys=function(e){const t=this.mesh.getObjectByName("armR"),n=this.mesh.getObjectByName("shaka");t&&(t.rotation.z=e?-2.65:-.45,t.rotation.x=e?.15:0,t.rotation.y=e?-.55:0),n&&(n.visible=e)};class I0{constructor(e){this.scene=e,this.water=E0(),this.wall=b0(),this.foam=T0(),this.clouds=w0(),this.sun=A0(),e.add(this.water,this.wall,this.foam,this.clouds,this.sun);const t=new b_("#bfe9ff","#0b4f78",1.2),n=new Oc("#fff1c9",1.45);n.position.set(-12,18,8),n.castShadow=!0;const s=new Oc("#9fe8ff",.55);s.position.set(6,8,12),e.add(t,n,s,new w_("#9fd7ff",.35)),e.background=new Ye("#73c7ff"),e.fog=new ho("#73c7ff",38,120)}update(e,t,n){const s=(this.water.material.uniforms.uOffset.value+t*n*.12)%1e3;this.water.material.uniforms.uTime.value=e,this.water.material.uniforms.uOffset.value=s,this.wall.material.uniforms.uTime.value=e,this.wall.material.uniforms.uOffset.value=s,this.clouds.position.z+=n*1.4,this.clouds.position.z>20&&(this.clouds.position.z=0)}}var oe,ah,oh,ch,lh,qi,hh,Ks,Ka,uh,Yi,dh,fh,ph,mh,gh,_h,Za,vh,Ja,xh,Zs,ja,Mh,Sh,Ki,yh,Eh,Rn;class N0{constructor(e){ri(this,oe);var t,n;this.canvas=e,this.lang=j_(),this.mode="menu",this.hud=new o0,this.input=new d0,this.clock=new R_,this.time=0,this.timeScale=1,this.renderer=new qg({canvas:e,antialias:!0}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.scene=new Yg,this.camera=new Gt(55,1,.1,200),this.camera.position.set(.2,3.8,9.2),this.camera.lookAt(0,1.1,-8),this.world=new I0(this.scene),this.player=new U0,this.scene.add(this.player.mesh),this.spawner=new P0(this.scene),this._shake=0,this.level=Ai[0],j(this,oe,Zs).call(this),this.pendingLife=0,this.lifeBlink=-1,this.deathCause="rock",this._portrait=!1,j(this,oe,Rn).call(this),window.addEventListener("resize",()=>j(this,oe,Rn).call(this)),window.addEventListener("orientationchange",()=>{setTimeout(()=>j(this,oe,Rn).call(this),180)}),(t=window.visualViewport)==null||t.addEventListener("resize",()=>j(this,oe,Rn).call(this)),(n=window.visualViewport)==null||n.addEventListener("scroll",()=>j(this,oe,Rn).call(this))}init(){this.input.attach(this.canvas),this.hud.setLang(this.lang),this.hud.showMenu(),j(this,oe,ah).call(this),this.clock.start(),j(this,oe,Rn).call(this),requestAnimationFrame(()=>j(this,oe,Rn).call(this)),this.renderer.setAnimationLoop(()=>j(this,oe,oh).call(this))}start(){var e,t;this.mode="play",this.lives=Bc,this.feet=0,this.teeth=0,this.tubes=0,this.cycleElapsed=0,this.stoke=0,this.flow=0,this.timeScale=1,this.travel=0,this.level=Ai[0],this.pendingLife=0,this.lifeBlink=-1,this.deathCause="rock",this._levelOneBanner=!1,j(this,oe,Zs).call(this),this.player.reset(),this.spawner.reset(),j(this,oe,qi).call(this)&&(this.spawner.nextAt=34),this.input.reset(),this.hud.hidePause(),this.hud.showPlay(),this.hud.update(j(this,oe,Ki).call(this)),(t=(e=document.activeElement)==null?void 0:e.blur)==null||t.call(e)}}oe=new WeakSet,ah=function(){document.getElementById("play").addEventListener("click",e=>{e.stopPropagation(),this.start()}),document.getElementById("restart").addEventListener("click",e=>{e.stopPropagation(),this.start()}),document.getElementById("stage-ok").addEventListener("click",e=>{e.stopPropagation(),this.mode==="stageclear"&&j(this,oe,Ja).call(this)}),this.hud.langBtns.forEach(e=>{e.addEventListener("pointerdown",t=>t.stopPropagation()),e.addEventListener("click",t=>{t.stopPropagation(),this.lang=$_(e.dataset.lang),this.hud.setLang(this.lang),(this.mode==="play"||this.mode==="paused")&&this.hud.update(j(this,oe,Ki).call(this)),this.mode==="stageclear"&&this.hud.showStageClear(this.level,{final:!Fs(this.level),...j(this,oe,ja).call(this)})})}),this.hud.pauseBtn.addEventListener("pointerdown",e=>e.stopPropagation()),this.hud.pauseBtn.addEventListener("click",e=>{e.stopPropagation(),this.mode==="play"&&j(this,oe,Ks).call(this)}),this.hud.replayBtn.addEventListener("pointerdown",e=>e.stopPropagation()),this.hud.replayBtn.addEventListener("click",e=>{e.stopPropagation(),(this.mode==="play"||this.mode==="paused")&&this.start()}),this.hud.pause.addEventListener("click",e=>{e.target.closest("[data-lang], button, .lang-row")||(e.stopPropagation(),this.mode==="paused"&&j(this,oe,Ka).call(this))}),this.canvas.addEventListener("pointerup",e=>{e.pointerType!=="mouse"||e.button!==0||this.mode==="play"&&j(this,oe,Ks).call(this)}),window.addEventListener("keydown",e=>{if(e.repeat)return;if(this.mode==="stageclear"){e.code==="Space"&&e.preventDefault(),(e.code==="Enter"||e.code==="NumpadEnter")&&(e.preventDefault(),j(this,oe,Ja).call(this));return}(e.code==="Escape"||e.code==="KeyP"||e.code==="Space")&&(this.mode!=="play"&&this.mode!=="paused"||(e.code==="Space"&&e.preventDefault(),this.mode==="play"?j(this,oe,Ks).call(this):j(this,oe,Ka).call(this)))})},oh=function(){const e=Math.min(this.clock.getDelta(),.05);if(this.mode==="paused"){this.renderer.render(this.scene,this.camera);return}this.time+=e,this.mode==="play"?j(this,oe,lh).call(this,e):j(this,oe,ch).call(this,e),j(this,oe,yh).call(this),this.renderer.render(this.scene,this.camera)},ch=function(e){this.world.update(this.time,10,e),this.player.update(e,{left:!1,right:!1,down:!1,jumpPressed:!1},this.time)},lh=function(e){if(this.flow>0&&(this.flow=Math.max(0,this.flow-e),this.timeScale=this.flow>0?Vc:1),this.stoke>0&&(this.stoke=Math.max(0,this.stoke-e)),this.pendingLife>0&&(this.pendingLife-=e,this.pendingLife<=0&&(this.pendingLife=0,j(this,oe,_h).call(this))),this.lifeBlink>=0&&(this.lifeBlink+=e,this.lifeBlink>=Ia&&(this.lifeBlink=-1)),this.mode!=="play")return;const t=e*this.timeScale;this.input.beginFrame(),this.cycleElapsed+=e;const n=j(this,oe,hh).call(this);if(this.feet+=n*t*V_,this.travel+=n*t,j(this,oe,Za).call(this),this.mode!=="play")return;j(this,oe,Mh).call(this),this.player.update(t,this.input,this.time);const s=this.player.consumeManeuver();s==="lip"&&this.hud.showBanner(ft(this.lang,"offTheLip")),s==="cutback"&&this.hud.showBanner(ft(this.lang,"cutback")),this.world.update(this.time,n,t),this.spawner.update(t,n,this.travel,this.player,{onHazard:r=>j(this,oe,uh).call(this,r.type),onKookDodge:()=>j(this,oe,dh).call(this),onSharkDodge:()=>j(this,oe,fh).call(this),onRockDodge:()=>j(this,oe,ph).call(this),onSignDodge:()=>j(this,oe,mh).call(this),onTube:r=>j(this,oe,gh).call(this,r)},this.level.spawn*(j(this,oe,qi).call(this)?B_:1),j(this,oe,qi).call(this)),this._shake>0&&(this._shake=Math.max(0,this._shake-t*8)),this.hud.update(j(this,oe,Ki).call(this))},qi=function(){return this._portrait||window.matchMedia("(hover: none) and (pointer: coarse)").matches},hh=function(){var s;const e=((s=this.level)==null?void 0:s.speed)??1,t=this.player.braking?U_:1,n=this.stoke>0?W_:1;return D_*e*t*n},Ks=function(){this.mode="paused",this.input.clearPointers(),this.hud.showPause()},Ka=function(){this.mode="play",this.clock.getDelta(),this.hud.hidePause(),this.hud.showPlay()},uh=function(e="rock"){this.player.invuln>0||(this.lives-=1,this.deathCause=["shark","kook","sign"].includes(e)?e:"rock",this.player.hit(),this.player.invuln=Ia,this.hud.hitFlash(),this._shake=1,this.lives<=0&&j(this,oe,Sh).call(this))},Yi=function(e,t=1100,n=""){this.hud.placeSpeech(e,t,n)},dh=function(){this.stageKooks+=1,j(this,oe,Yi).call(this,ft(this.lang,"kookSpeech"))},fh=function(){this.teeth+=1,this.stageTeeth+=1},ph=function(){this.stageRocks+=1},mh=function(){this.stageSigns+=1},gh=function(e){e&&(this.tubes+=1,this.stageTubes+=1,this.hud.showBanner(ft(this.lang,"tubeRide")),this.player.celebrateHaka(Br),j(this,oe,Yi).call(this,ft(this.lang,"hakaSurf"),Br*1e3),this.pendingLife=Br,this.stoke=H_,this.flow=X_,this.timeScale=Vc)},_h=function(){this.lives<Ws?(this.lives+=1,this.lifeBlink=0,j(this,oe,Yi).call(this,ft(this.lang,"extraLife"),1200,Na)):(this.feet+=q_,j(this,oe,Yi).call(this,ft(this.lang,"bonusLife"),1200,Na),j(this,oe,Za).call(this))},Za=function(){this.mode==="play"&&(this.feet<Hc(this.level)||j(this,oe,vh).call(this))},vh=function(){this.mode="stageclear",this.input.clearPointers(),this._levelOneBanner=!0,this.hud.showStageClear(this.level,{final:!Fs(this.level),...j(this,oe,ja).call(this)})},Ja=function(){this.mode==="stageclear"&&(Fs(this.level)?j(this,oe,xh).call(this):this.start())},xh=function(){var t,n;const e=Fs(this.level);if(!e){this.start();return}this.level=e,this.cycleElapsed=0,this.stoke=0,this.flow=0,this.timeScale=1,this.pendingLife=0,this.lifeBlink=-1,this.travel=0,this._levelOneBanner=!0,j(this,oe,Zs).call(this),this.player.reset(),this.spawner.reset(),j(this,oe,qi).call(this)&&(this.spawner.nextAt=34),this.input.reset(),this.mode="play",this.clock.getDelta(),this.hud.hidePause(),this.hud.showPlay(),this.hud.update(j(this,oe,Ki).call(this)),this.hud.showLevelBanner(this.level),(n=(t=document.activeElement)==null?void 0:t.blur)==null||n.call(t)},Zs=function(){this.stageTeeth=0,this.stageTubes=0,this.stageKooks=0,this.stageRocks=0,this.stageSigns=0},ja=function(){var t;const e=((t=this.level)==null?void 0:t.atFeet)??0;return{goalDistance:Math.max(0,Hc(this.level)-e),teeth:this.stageTeeth??0,tubes:this.stageTubes??0,kooks:this.stageKooks??0,rocks:this.stageRocks??0,signs:this.stageSigns??0}},Mh=function(){this._levelOneBanner||this.cycleElapsed<2||(this._levelOneBanner=!0,this.hud.showLevelBanner(this.level))},Sh=function(){var e,t;this.mode="gameover",this.hud.showGameOver({feet:this.feet,teeth:this.teeth,tubes:this.tubes,cause:this.deathCause,tier:((t=(e=this.level)==null?void 0:e.wave)==null?void 0:t.tier)??"beginner"})},Ki=function(){var e,t,n,s;return{lives:this.lives??Bc,lifeBlink:this.lifeBlink??-1,feet:this.feet??0,displayDistance:zl(this.lang,this.feet??0),teeth:this.teeth??0,tubes:this.tubes??0,levelId:((e=this.level)==null?void 0:e.id)??1,levelFlag:Da((t=this.level)==null?void 0:t.wave),levelName:La((n=this.level)==null?void 0:n.wave,this.lang),levelDesc:P_((s=this.level)==null?void 0:s.wave,this.lang),braking:this.mode==="play"&&this.player.braking,stoke:this.stoke??0,flow:this.flow??0}},yh=function(){const e=an(this.player.x),t=this._portrait,n=new L(this.player.x*(t?.12:.2)+(t?.55:1.5),e+(t?1.35:1.55)+this.player.y*.2,t?-11:-8),s=new L(this.player.x*(t?.14:.22)-(t?.45:1.5),e+(t?5.35:4.15),t?13.6:10.2);this._shake>0&&(s.x+=(Math.random()-.5)*this._shake*.35,s.y+=(Math.random()-.5)*this._shake*.2),this.camera.position.lerp(s,.08),this.camera.lookAt(n)},Eh=function(){const e=window.visualViewport;return e?{w:Math.max(1,Math.round(e.width)),h:Math.max(1,Math.round(e.height)),left:Math.round(e.offsetLeft),top:Math.round(e.offsetTop)}:{w:Math.max(1,window.innerWidth),h:Math.max(1,window.innerHeight),left:0,top:0}},Rn=function(){const{w:e,h:t,left:n,top:s}=j(this,oe,Eh).call(this);document.documentElement.style.setProperty("--app-w",`${e}px`),document.documentElement.style.setProperty("--app-h",`${t}px`),document.documentElement.style.setProperty("--app-left",`${n}px`),document.documentElement.style.setProperty("--app-top",`${s}px`),this.renderer.setSize(e,t,!1),this.camera.aspect=e/t,this._portrait=this.camera.aspect<.82;const r=yt.degToRad(this._portrait?46:38),a=yt.radToDeg(2*Math.atan(Math.tan(r/2)/Math.max(.35,this.camera.aspect)));this.camera.fov=yt.clamp(this._portrait?Math.max(62,a):55,52,72),this.camera.updateProjectionMatrix()};const Gr="kook-reload-v";function O0(){const i="1789327065298";return fetch(`./version.json?t=${Date.now()}`,{cache:"no-store"}).then(e=>e.ok?e.json():null).then(e=>{const t=(e==null?void 0:e.v)!=null?String(e.v):"";if(!t||t===i){sessionStorage.removeItem(Gr);return}if(sessionStorage.getItem(Gr)===t)return;sessionStorage.setItem(Gr,t);const n=new URL(location.href);n.searchParams.set("_v",t),location.replace(n.toString())}).catch(()=>{})}O0();const bh=new N0(document.getElementById("game"));bh.init();window.game=bh;
